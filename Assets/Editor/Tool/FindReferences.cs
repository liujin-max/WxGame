...
public class SearchRefrenceEditorWindow : EditorWindow
{
    ...
    /// 查找引用
    /// </summary>
    [MenuItem("Tools/查找依赖关系")]
    static void SearchRefrence()
    {
        SearchRefrenceEditorWindow window =
            (SearchRefrenceEditorWindow) EditorWindow.GetWindow(typeof(SearchRefrenceEditorWindow), false, "Searching",
                true);
        window.Show();
    }
