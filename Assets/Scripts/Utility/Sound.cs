...
public class Sound : MonoBehaviour
{
    ...
    void OnEnable()
    {
        ...
        if (IsPlayLimit) GameFacade.Instance.SoundManager.AddPlayingSound(m_AudioSource.clip.name);
    }
    ...
    void Update()
    {
        ...
        if (m_AudioSource.isPlaying == false) {
            m_IsPlayed = false;
            if (IsPlayLimit) GameFacade.Instance.SoundManager.ReducePlayingSound(m_AudioSource.clip.name);
